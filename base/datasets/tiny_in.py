...
class TinyImageNet(BaseDataset):
    def ds_train(self):
        ...
        return TinyImageNet_load(root="data/tiny-imagenet-200/", train=True, transform=t)
    ...
    def ds_test(self):
        t = base_transform()
        return TinyImageNet_load(root="data/tiny-imagenet-200/", train=False, transform=t)
